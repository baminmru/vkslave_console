...
'Ext.form.*'
  ...
  vktsk_= null;
function VKTSK_Panel_(objectID, RootPanel, selection){ 
    ...
    var store_vk_taskmsg = Ext.create('Ext.data.Store', {
        ...
        proxy: {
          ...
          DefineForms_vk_taskinfo_();
          DefineForms_vk_taskmsg_();
     var   int_vk_taskinfo_     =      DefineInterface_vk_taskinfo_('int_vk_taskinfo',store_vk_taskinfo, selection);
     var   int_vk_taskmsg_     =      DefineInterface_vk_taskmsg_('int_vk_taskmsg',store_vk_taskmsg);
     vktsk_= Ext.create('Ext.form.Panel', {
      id: 'vktsk',
      layout:'fit',
      ...
      fieldDefaults: {
        ...
        instanceid:objectID,
        		...
        		{
        			var me = this;
        	    int_vk_taskinfo_.doSave( me.onCommit);
        		},
        		onButtonCancel: function()
        		{
        		},
        canClose: function(){
        	return int_vk_taskinfo_.canClose();
        },
        items: [{
            xtype:'tabpanel',
            itemId:'tabs_vktsk',
...
int_vk_taskmsg_
    ...
    if(RootPanel==true){
       vktsk_.closable= true;
       vktsk_.title= 'Задача';
       vktsk_.frame= true;
    }else{
       vktsk_.closable= false;
       vktsk_.title= '';
       vktsk_.frame= false;
    }
   ...
   int_vk_taskinfo_.setActiveRecord(record,objectID);	
   });
       store_vk_taskinfo.load( {params:{ instanceid:objectID} }  );
   int_vk_taskmsg_.instanceid=objectID;	

...
function DefineInterface_vk_adovstat_main(id,mystore){
...
var p1_valid=false;
     function onSave(close_after_save,callaftersave){
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                url: rootURL+'index.php/c_vk_adovstat/setRow',
                method:  'POST',
                params: { 
                    instanceid: p1.instanceid
                    ,vk_adovstatid: active.get('vk_adovstatid')
	            ...
	            if(res.success==false){
                    ...
                    if(active.get('vk_adovstatid')==''){
               			active.set('vk_adovstatid',res.data['vk_adovstatid']);
                    }
        		   /* Ext.MessageBox.show({
                        title:  'Подтверждение',
                   ...
                   if(selection){
                     Ext.Ajax.request({
                        url: rootURL+'index.php/c_v_autovk_adovstat/getRows?&filter=[{"property":"vk_adovstatid","value":"'+ active.get('vk_adovstatid') + '"}]',
                        method:     'GET',
                        success: function(response){
...
function DefineForms_vk_adovstat_main(){


Ext.define('Form_vk_adovstatmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_vk_adovstatmain',
...
allowBlank:true
    ...
    onReset: function(){
        if(this.activeRecord.get('vk_adovstatid')==''){
...
Ext.define('EditWindow_vk_adovstatmain', {

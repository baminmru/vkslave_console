...
function DefineInterface_vk_adstat_main(id,mystore){

var groupingFeature_vk_adstat = Ext.create('Ext.grid.feature.Grouping',{
...
showGroupsText:  'Показать группировку'
 ...
 var p1;
    function onDeleteConfirm(selection){
      if (selection) {
        Ext.Ajax.request({
            url:    rootURL+'index.php/c_vk_adstat/deleteRow',
            method:  'POST',
    		params: { 
    				vk_adstatid: selection.get('vk_adstatid')
    				}
    	});
    ...
    function onAddClick(){
   	if(CheckOperation('VKADS.edit')!=0){
                var edit = Ext.create('EditWindow_vk_adstatmain');
                p1.store.insert(0, new model_vk_adstat());
 ...
 p1=   new Ext.grid.Panel(
      ...
      stateful:stateFulSystem,
       stateId:  'vk_adstatmain',
        iconCls:  'icon-grid',
        frame: true,
        instanceid: '',
        features: [groupingFeature_vk_adstat ],
          dockedItems: [{
                xtype:  'toolbar',
                items: [
                {
...
function DefineForms_vk_adstat_main(){


Ext.define('Form_vk_adstatmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_vk_adstatmain',
...
allowBlank:true
    ...
    onSave: function(){
        ...
        if (form.isValid()) {
            ...
            Ext.Ajax.request({
                url: rootURL+'index.php/c_vk_adstat/setRow',
                method:  'POST',
                params: { 
                    instanceid: this.instanceid
                    ,vk_adstatid: active.get('vk_adstatid')
	            ...
	            if(res.success==false){
                    ...
                    if(active.get('vk_adstatid')==''){
               			active.set('vk_adstatid',res.data['vk_adstatid']);
                    }
    ...
    onReset: function(){
        if(this.activeRecord.get('vk_adstatid')==''){
...
Ext.define('EditWindow_vk_adstatmain', {

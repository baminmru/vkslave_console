...
function DefineInterface_vk_camstat_(id,mystore){
...
showGroupsText:  'Показать группировку'
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('VKCAM.edit')!=0){
                var edit = Ext.create('EditWindow_vk_camstat');
...
function DefineForms_vk_camstat_(){


Ext.define('Form_vk_camstat', {
extend:  'Ext.form.Panel',
alias: 'widget.f_vk_camstat',
...
Ext.define('EditWindow_vk_camstat', {

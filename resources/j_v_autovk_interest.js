...
var groupingFeature_autovk_interest = Ext.create('Ext.grid.feature.Grouping',{
groupByText:  'Группировать по этому полю',
showGroupsText:  'Показать группировку'
});
var interval_autovk_interest;
Ext.define('grid_autovk_interest', {
    extend:  'Ext.grid.Panel',
    alias: 'widget.g_v_autovk_interest',
    requires: [
        'Ext.grid.*',
        'Ext.form.field.Text',
    ...
    initComponent: function(){
        Ext.apply(this, {
        frame: false,
        store: store_v_autovk_interest,
        features: [groupingFeature_autovk_interest],
        ...
        columns: [
            {text: "Название", width:400, dataIndex: 'vk_interest_title', sortable: true}
            ,
            {text: "vkid", width:400, dataIndex: 'vk_interest_vkid', sortable: true}
        ]
        ,
...
value:  '',
name:   'vk_interest_title',
itemId:   'vk_interest_title',
fieldLabel:  '',
emptyText:      'Название',
hideLabel:  true,
...
xtype:  'numberfield',
value:  '0',
name:   'vk_interest_vkid_ge',
itemId:   'vk_interest_vkid_ge',
fieldLabel:  'vkid >=',
emptyText:      'не задано',
...
xtype:  'numberfield',
value:  '0',
name:   'vk_interest_vkid_le',
itemId:   'vk_interest_vkid_le',
fieldLabel:  'vkid <=',
emptyText:      'не задано',
submitEmptyText: false,
listeners: {render: function(e) {Ext.QuickTips.register({  target: e.getEl(), text: 'vkid <='});}}
    ...
    listeners: {
        ...
        ,
        	added:function(){
        			//interval_autovk_interest= setInterval(function() {  
        			//	store_v_autovk_interest.load();
        			//}, 60000);
        		}
        	,
        	destroy:function(){
        		//clearInterval(interval_autovk_interest);
        }
    },
    onDeleteConfirm:function(selection){
      if (selection) {
        Ext.Ajax.request({
            url:    rootURL+'index.php/c_v_autovk_interest/deleteRow',
            method:  'POST',
    		params: { 
    ...
    onDeleteClick: function(){
      ...
      if (selection) {
   	    if(CheckOperation('VDINTER.edit')!=0 && OTAllowDelete('VDINTER')){
        Ext.Msg.show({
            title:  'Удалить?',
    ...
    onAddClick: function(){
   	    if(CheckOperation('VDINTER.edit')!=0 && OTAllowAdd('VDINTER')){
            Ext.Ajax.request({
                url: rootURL+'index.php/c_v_autovk_interest/newRow',
                method:  'POST',
                params: { 
                },
...
function VDINTER_Jrnl(){ 
  ...
  var VDINTER= Ext.create('Ext.form.Panel', {
      ...
      fieldDefaults: {
        ...
        items: [{
            itemId:'gr_autovk_interest',
            xtype:'g_v_autovk_interest',
            stateful: stateFulSystem,
            stateId:'j_v_autovk_interest',
            layout: 'fit',
            flex: 1,
            store: store_v_autovk_interest
    }] // tabpanel
...
Ext.define('ObjectWindow_vdinter', {

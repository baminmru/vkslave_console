...
function DefineInterface_vk_usr_main(id,mystore,selection){
...
function DefineForms_vk_usr_main(){


Ext.define('Form_vk_usrmain', {
extend:  'Ext.form.Panel',
alias: 'widget.f_vk_usrmain',
...
Ext.define('EditWindow_vk_usrmain', {

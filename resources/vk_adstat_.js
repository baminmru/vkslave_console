...
function DefineInterface_vk_adstat_(id,mystore){
...
showGroupsText:  'Показать группировку'
 ...
 var p1;
    ...
    function onAddClick(){
   	if(CheckOperation('VKADS.edit')!=0){
                var edit = Ext.create('EditWindow_vk_adstat');
...
function DefineForms_vk_adstat_(){


Ext.define('Form_vk_adstat', {
extend:  'Ext.form.Panel',
alias: 'widget.f_vk_adstat',
...
Ext.define('EditWindow_vk_adstat', {

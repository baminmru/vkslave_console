...
<?php
class  M_v_autovk_region extends CI_Model {
    ...
    function newRow($objtype,$name)  {
               ...
               $this->jservice->get(array('Action'=>'NewDocument', 'TypeName'=>'VDRG', 'DocumentID'=>$id, 'DocumentCaption'=>$name));
               $rowid = $this->jservice->get(array('Action'=>'NewGuid'));
               $this->jservice->get(array('Action'=>'NewRow', 'PartName'=>'vk_region', 'RowID'=>$rowid, 'DocumentID'=>$id));
                if ($id) {
	    ...
	    foreach($filter as $obj) {
		    ...
		    switch($obj->property) {
			    //case 'value':
			    	//$cond = '';
			    	//break;
			  case 'vk_region_vkid_le':
			  $cond = 'vk_region_vkid<='.$obj->value;
			  break;
			  case 'vk_region_vkid_ge':
			  $cond = 'vk_region_vkid>='.$obj->value;
			  break;
		    	default:
			    	if(isset($obj->value))
    ...
    function deleteRow($id = null) {
	    $this->jservice->get(array('Action'=>'DeleteDocument', 'TypeName'=>'vdrg', 'DocumentID'=>$id));

...
class  M_v_autovk_os extends CI_Model {
    ...
    try{
	 ...
	 if (isset($offset) && isset($limit)) {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autovk_os','FieldList'=>'instanceid,id,vk_os_vkid,vk_os_title','Sort'=>$sort, 'WhereClause' => $whereclause,'Limit'=>$limit,'Offset'=>$offset));
	} else {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autovk_os','FieldList'=>'instanceid,id,vk_os_vkid,vk_os_title','Sort'=>$sort, 'WhereClause' => $whereclause));
	}
	$root = new stdClass();
	$root->total = $this->jservice->get(array('Action' => 'CountView', 'ViewName' => 'v_autovk_os','FieldList'=>'instanceid,id,vk_os_vkid,vk_os_title', 'WhereClause' => $whereclause));
	$root->success = true;
	$root->rows = $res;
	return $root;
}

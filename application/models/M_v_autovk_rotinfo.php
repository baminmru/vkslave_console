...
<?php
class  M_v_autovk_rotinfo extends CI_Model {
    ...
    function newRow($objtype,$name)  {
               ...
               $this->jservice->get(array('Action'=>'NewDocument', 'TypeName'=>'VKROT', 'DocumentID'=>$id, 'DocumentCaption'=>$name));
               $rowid = $this->jservice->get(array('Action'=>'NewGuid'));
               $this->jservice->get(array('Action'=>'NewRow', 'PartName'=>'vk_rotinfo', 'RowID'=>$rowid, 'DocumentID'=>$id));
                if ($id) {
    ...
    function deleteRow($id = null) {
	    $this->jservice->get(array('Action'=>'DeleteDocument', 'TypeName'=>'vkrot', 'DocumentID'=>$id));

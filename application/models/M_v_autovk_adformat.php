...
<?php
class  M_v_autovk_adformat extends CI_Model {
    ...
    function newRow($objtype,$name)  {
               ...
               $this->jservice->get(array('Action'=>'NewDocument', 'TypeName'=>'VDFRMT', 'DocumentID'=>$id, 'DocumentCaption'=>$name));
               $rowid = $this->jservice->get(array('Action'=>'NewGuid'));
               $this->jservice->get(array('Action'=>'NewRow', 'PartName'=>'vk_adformat', 'RowID'=>$rowid, 'DocumentID'=>$id));
                if ($id) {
	    ...
	    foreach($filter as $obj) {
		    ...
		    switch($obj->property) {
			    //case 'value':
			    	//$cond = '';
			    	//break;
			  case 'vk_adformat_vkid_le':
			  $cond = 'vk_adformat_vkid<='.$obj->value;
			  break;
			  case 'vk_adformat_vkid_ge':
			  $cond = 'vk_adformat_vkid>='.$obj->value;
			  break;
		    	default:
			    	if(isset($obj->value))
    ...
    function deleteRow($id = null) {
	    $this->jservice->get(array('Action'=>'DeleteDocument', 'TypeName'=>'vdfrmt', 'DocumentID'=>$id));

...
class  M_v_autovk_trginfo extends CI_Model {
    ...
    try{
	 ...
	 if (isset($offset) && isset($limit)) {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autovk_trginfo','FieldList'=>'instanceid,id,vk_trginfo_info,vk_trginfo_cab,vk_trginfo_vkid,vk_trginfo_name,vk_trginfo_audience_count,vk_trginfo_lifetime,vk_trginfo_pixel,vk_trginfo_trgdomain','Sort'=>$sort, 'WhereClause' => $whereclause,'Limit'=>$limit,'Offset'=>$offset));
	} else {
	    $res = $this->jservice->get(array('Action' => 'GetViewData', 'ViewName' => 'v_autovk_trginfo','FieldList'=>'instanceid,id,vk_trginfo_info,vk_trginfo_cab,vk_trginfo_vkid,vk_trginfo_name,vk_trginfo_audience_count,vk_trginfo_lifetime,vk_trginfo_pixel,vk_trginfo_trgdomain','Sort'=>$sort, 'WhereClause' => $whereclause));
	}
	$root = new stdClass();
	$root->total = $this->jservice->get(array('Action' => 'CountView', 'ViewName' => 'v_autovk_trginfo','FieldList'=>'instanceid,id,vk_trginfo_info,vk_trginfo_cab,vk_trginfo_vkid,vk_trginfo_name,vk_trginfo_audience_count,vk_trginfo_lifetime,vk_trginfo_pixel,vk_trginfo_trgdomain', 'WhereClause' => $whereclause));
	$root->success = true;
	$root->rows = $res;
	return $root;
}
